...
function Main() {
    ...
    const infoText = (
        <div className="infoSection">
            ...
            <a
                href="https://www.linkedin.com/in/timwneale/"
                rel="noreferrer"
                target="_blank"
                className="imageLink"
            >
                ...
                setContent(
                    <>
                        ...
                        >
                            ...
                            >
                                Starting here as a co-op student in my junior
                                year of college, I had little experience with{' '}
                                <span className="important">Javascript</span>. I
                                learned it well while learning the already
                                established code-base, and went to be offered a
                                full time position after graduation.
                                <br />
                                Worked directly with the company's CTO and CEO
                                on features and their specifications for
                                development, and used{' '}
                                <span className="important">GitLab</span> to
                                track progress and version control.
                                <br />
                                ...
                                on both web and mobile applications, including
                                total overhaul on the Training Management
                                System, as requested by customers.
                                <br />
                                This{' '}
                                <span className="important">
                                    fast-paced environment
                                </span>{' '}
                                had us developing features, testing them, and
                                deploying them as they were done in batches.
                                This also had us{' '}
                                <span className="important">
                                ...
                                from this job opportunity as well, as our
                                customer base grew and the needs of those
                                customers grew with it, we had to deal with ever
                                growing datasets, and account for a lot of data
                                when trying to handle calculations in the
                                backend.
                                <br />
                                Learning{' '}
                                ...
                                to link with our{' '}
                                <span className="important">MongoDB</span>, I
                                went into this workplace with a lot of unknowns,
                                but now I would consider myself a near expert in
                                a lot of the software we used.
                            </p>
                        </div>
                        <div
                            className={
                        ...
                        >
                            ...
                            >
                                My first co-op, starting in my sophomore year of
                                college, I stayed here for 3 separate co-op
                                terms, and relocated to Stow, OH each term.
                                <br />I went into this position with only{' '}
                                <span className="important">Java</span>{' '}
                                knowledge, but learned the culture well, and
                                learned web development with{' '}
                                <span className="important">
                                    Red Hat Studio
                                </span>
                                , a modified version of{' '}
                                <span className="important">Eclipse</span>.
                                <br />
                                Working in a small development team for a larger
                                company, adding and modifying pages on{' '}
                                <a
                                ...
                                to fit new features and color options from
                                engineering specifications.
                                <br />
                                <br />A lot of this experience was learning
                                coding in an actual industry rather than in a
                                classroom or on personal projects.
                                <br />
                                Being given deadlines and actual marketing
                                specifications, coming to terms that some things
                                seem wrong but thats what customers want, it was
                                genuinely a great learning experience.
                            </p>
                        </div>
                    </>
                );
                    ...
                    <>
                        ...
                        >
                            ...
                            >
                                <h2>
                                    <a
                                        href="https://github.com/nealetw/discordBot"
                                        rel="noreferrer"
                                        target="_blank"
                                    >
                                        Discord Bots
                            ...
                            >
                                ...
                                <br />
                                The link to the left goes to one of my first
                                iterations, though its a bit depricated. I've
                                worked on a newer one that is privately
                                maintained, with a newer version of DiscordJs,
                                as an update broke the entire bot (Woo!).
                                <br />
                                <a
                        ...
                        >
                            ...
                            >
                                <h2>
                                    <a
                                        href="https://github.com/nealetw/Senior_Design_Project_Hackney_Neale"
                                        rel="noreferrer"
                                        target="_blank"
                                    >
                                        Cat GAN
                            ...
                            >
                                My senior capstone at University of Cincinnati,
                                my partner and I researched and trained a{' '}
                                <span className="important">
                                ...
                                and our local computers at home to train it, but
                                near the end of the project, we did get some
                                time to train it remotely using a{' '}
                                <span className="important">
                                    research computer at OSU
                                </span>
                                . The results were still rough, but our dataset
                                was fairly small compared to what other GANs
                                have used before,
                                <br />
                                Much of the challenge with this project was
                                settling on a technology, as we went through
                                many neural network libraries to try to find
                                what would fit our use case. This included
                                almost a month of trying to fit{' '}
                                <span className="important">PyTorch</span> to
                                our use case.
                            </p>
                        </div>
                        ...
                        >
                            ...
                            >
                                <h2>
                                    <a
                                        href="https://github.com/nealetw/roboticsCodeCopy"
                                        rel="noreferrer"
                                        target="_blank"
                                    >
                                        High School FRC
                            ...
                            >
                                Some of my first group code, this is a copy of
                                the <span className="important">Java</span> code
                                I contributed to for team ScotBot 4284 (Oak
                                Hills High School) competing in{' '}
                                <span className="important">
                                ...
                                <span className="important">Java</span> in an
                                Advanced Placement class, and I consider it some
                                of my first actual development.
                                <br />
                                This also included{' '}
                                <span className="important">
                                ...
                                communicating across multiple teams to make sure
                                ...
                                even during competition, we did end up going to
                        ...
                        >
                            ...
                            >
                                <h2>
                                    <a
                                        href="https://github.com/nealetw/personalSite"
                                        rel="noreferrer"
                                        target="_blank"
                                    >
                                        This site!
                            ...
                            >
                                With my free time, and a need to show off my
                                work/portfolio, I deployed this{' '}
                                <span className="important">React</span> website
                                in a few days. Its hosted on an{' '}
                                <span className="important">
                                    AWS EC2 instance
                                </span>
                                , and I keep it up to date with{' '}
                                <span className="important">Github + SSH</span>
                                <br />
                                Over time, I've wanted to add more and more
                                things, and my friend told me to add a game
                                similar to{' '}
                                <a
                                ...
                                . Seeing it as a challenge to push the limits of
                                my knowledge, I{' '}
                                <a
                                    href="/clicker"
                                    rel="noreferrer"
