...
function Main() {
  ...
  const infoText = (
    <div className='infoSection'>
      ...
      <img  alt='Jerry'  onClick={() => onJerryClick(2)} className={'jerry2'} src={require('./../../images/jerry.png')} />
      : <></>}
  </div>
  );
    ...
    switch (selectedTab) {
        ...
        setContent(<>
          ...
          <div className={isMobile ? 'smallSection' : 'contentSection'}>
            <div className={isMobile ? 'smallSectionTitle' :  'sectionTitle'}>
              ...
              {!isMobile && miniGame[0] ?
              <img alt='Jerry'  onClick={() => miniGame[1] ? {} : onJerryClick(1)} className={miniGame[1] ? 'jerry1Revealed' : 'jerry1'} src={require('./../../images/jerry.png')} />
              : <></>}
            </div>
      ...
      case 'personal':
        setContent(<>
          ...
          <img alt='Jerry' onClick={() => onJerryClick(3)} className={'jerry3'} src={require('./../../images/jerry.png')} />
          : <></>}
  ...
  return (
    <div className="App">
      <div className="App-header">
        ...
        {!isMobile ? <img alt='Jerry' onClick={() => miniGame[0] ? {} : onJerryClick(0)} className={miniGame[0] ? 'jerry0Revealed' : 'jerry0'} src={require('./../../images/jerry.png')} /> : <></>}
        {!isMobile && miniGame[1] ? <img alt='Jerry' className='jerry1Revealed' src={require('./../../images/jerry.png')} /> : <></>}
        {!isMobile && miniGame[2] ? <img alt='Jerry' className='jerry2Revealed' src={require('./../../images/jerry.png')} /> : <></>}
        {!isMobile && miniGame[3] ? <img alt='Jerry' className='jerry3Revealed' src={require('./../../images/jerry.png')} /> : <></>}
      ...
      {winModal ?
        <div id="modal" class="modal">
          <div className="modal-content">
            ...
            <img alt='Jerry' className='completedJerrys' src={require('./../../images/blob.gif')} />
            <p>If you like clicking deer that much, try my stupid <a href='/clicker'>deer clicking game</a>!</p>
          </div>
        </div> :
      <></>}
